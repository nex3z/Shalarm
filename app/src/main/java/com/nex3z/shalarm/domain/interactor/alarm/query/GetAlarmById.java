...
public class GetAlarmById extends UseCase<GetAlarmByIdArg>{
    private final String LOG_TAG = GetAlarmById.class.getSimpleName();

    private final AlarmRepository mRepository;

    public GetAlarmById(AlarmRepository repository, ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        ...
        return mRepository.getAlarmById(mArg.getId());
    }
}
